<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"E:\wamp\www\aiyics\thinkphp\ed/../ed_app/index\view\superconservator\superconservator_user_update.html";i:1542678933;s:63:"E:\wamp\www\aiyics\thinkphp\ed_app\index\view\public\cssjs.html";i:1542174800;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
								...
								<div class="tabbable header-tabs">
								    ...
								    <div class="tab-content">
									 	...
									 	<!-- 临床信息录入  onkeydown="if(event.keyCode==13)return false;"-->
									 		<form action="<?php echo url('Superconservator/SuperconservatorUserUpdate'); ?>" method="post" id="formID">
														  	...
														  	<div class="col-md-12 .col-lg-12 .col-sm-12 ">
																<div class="row">
																  	...
																  	<div class="col-md-4 .col-lg-4 .col-sm-4">
															 			...
															 			<div>
															 				<input class="inputting_listInput" type="text" name="account" id="account" value="<?php echo $loginuserdl['account']; ?>" />
															 			</div>
																			...
																			<table id="example" cellpadding="0" cellspacing="0" border="0" class="table">
																				<thead id="volistThead">
																					<tr>
																						...
																						<td>
																							<input type="checkbox" name="check[]" value="<?php echo $pt['id']; ?>" <?php if(is_array($projectcselectsomeone) || $projectcselectsomeone instanceof \think\Collection || $projectcselectsomeone instanceof \think\Paginator): $i = 0; $__LIST__ = $projectcselectsomeone;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pte): $mod = ($i % 2 );++$i;if(($pt['id'] == $pte['pid'])): ?> checked="checked" <?php endif; endforeach; endif; else: echo "" ;endif; ?>/>
																							<?php echo $pt['projectname']; ?>
																						</td>
																						<td><input class="price" type="text" name="<?php echo $pt['id']; ?>" id="head"  placeholder="价格单位:元" <?php if(is_array($projectcselectsomeone) || $projectcselectsomeone instanceof \think\Collection || $projectcselectsomeone instanceof \think\Paginator): $i = 0; $__LIST__ = $projectcselectsomeone;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pte): $mod = ($i % 2 );++$i;if(($pt['id'] == $pte['pid'])): ?> value="<?php echo $pte['price']; ?>" <?php endif; endforeach; endif; else: echo "" ;endif; ?>/></td>
																		...
																		<div>
																			<input class="inputting_listInput" type="text" name="head" id="head" value="<?php echo $loginuserdl['head']; ?>"/>
																		</div>
																		<div class="inputting_listTltie">* 权限</div>
																		<div>
																			<input class="dxk" type="radio" name="permissions" id="permissions" value="0" <?php if(($loginuserdl['superconservator'] == 0)): ?> checked="checked" <?php endif; ?> />普通用户
																			<input class="dxk" type="radio" name="permissions" id="permissions" value="2" <?php if(($loginuserdl['superconservator'] == 2)): ?> checked="checked" <?php endif; ?>/>实验室
																		</div>
															 		</div>
															 	</div>
															 	<div class="infoBox">
															 		<input type="hidden" name="hid" value="<?php echo $accountid; ?>">
