<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"E:\wamp\www\aiyics\thinkphp\ed/../ed_app/index\view\thequery\thequery.html";i:1542700297;s:63:"E:\wamp\www\aiyics\thinkphp\ed_app\index\view\public\cssjs.html";i:1542174800;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                                ...
                                <div class="tabbable header-tabs">
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="box_tab4">
                                            <form action="<?php echo url('Buildlibrarymanagement/BuildLibraryManagement'); ?>" method="post" enctype="multipart/form-data">
