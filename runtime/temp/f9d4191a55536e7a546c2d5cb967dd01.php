<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\wamp\www\aiyics\thinkphp\ed/../ed_app/index\view\index\index.html";i:1541991528;s:62:"E:\wamp\www\aiyics\thinkphp\ed_app\index\view\public\base.html";i:1542345154;s:64:"E:\wamp\www\aiyics\thinkphp\ed_app\index\view\public\header.html";i:1542790548;s:62:"E:\wamp\www\aiyics\thinkphp\ed_app\index\view\public\left.html";i:1542791053;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="nav navbar-nav pull-right">
				<li class="dropdown user" id="header-user">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo url('Login/ChangePassword'); ?>">密码修改</a></li>
...
<div id="sidebar" class="sidebar">
	<div class="sidebar-menu nav-collapse">
		...
		<ul class="indexUl">
			<?php if(($permissions == 1 or $permissions == 2 or $permissions == 5)): ?>
			<li class="has-sub">
				<a class="">
				...
				<ul class="sub">
					...
					<li>
						...
						<ul class="sub_3">
							...
							<li>
								<span></span>
								<a class="" href="<?php echo url('Buildlibrarymanagement/BuildLibraryManagementfile',['hasnot'=>2]); ?>" target='demo_frame'>
								<span class="sub-menu-text">建库文件</span>
								</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul class="sub_3">
							...
							<li>
								<a class="" href="<?php echo url('Buildlibrarymanagement/BuildLibraryManagementFile',['hasnot'=>3]); ?>" target='demo_frame'>
								<span class="sub-menu-text">上机文件</span>
								</a>
							</li>
						</ul>
					</li>
			...
			<?php endif; if(($permissions == 1 or $permissions == 2)): ?>
			<li class="has-sub">
